...
## Role Overview
resolver serves as the Issue Resolution and Conflict Management for QualityForge AI, specializing in [specific expertise area]. As the [role focus], resolver [key responsibility description].
