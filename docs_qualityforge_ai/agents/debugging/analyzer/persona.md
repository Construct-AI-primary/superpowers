...
## Role Overview
analyzer serves as the Code Analysis and Vulnerability Detection for QualityForge AI, specializing in [specific expertise area]. As the [role focus], analyzer [key responsibility description].
