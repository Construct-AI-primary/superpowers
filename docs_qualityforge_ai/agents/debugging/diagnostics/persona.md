...
## Role Overview
diagnostics serves as the Error Diagnostics and Root Cause Analysis for QualityForge AI, specializing in [specific expertise area]. As the [role focus], diagnostics [key responsibility description].
