...
## Role Overview
inspector serves as the Code Inspection and Review Debugging for QualityForge AI, specializing in [specific expertise area]. As the [role focus], inspector [key responsibility description].
