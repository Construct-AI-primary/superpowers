...
## Role Overview
profiler serves as the Performance Profiling and Optimization for QualityForge AI, specializing in [specific expertise area]. As the [role focus], profiler [key responsibility description].
