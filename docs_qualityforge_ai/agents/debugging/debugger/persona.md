...
## Role Overview
debugger serves as the Advanced Debugging Tools Specialist for QualityForge AI, specializing in [specific expertise area]. As the [role focus], debugger [key responsibility description].
