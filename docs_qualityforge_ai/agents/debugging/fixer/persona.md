...
## Role Overview
fixer serves as the Bug Fixing and Patch Development for QualityForge AI, specializing in [specific expertise area]. As the [role focus], fixer [key responsibility description].
