...
## Role Overview
e2e serves as the End-to-End Testing Coordinator for QualityForge AI, specializing in [specific expertise area]. As the [role focus], e2e [key responsibility description].
