...
## Role Overview
integration serves as the Integration Testing Expert for QualityForge AI, specializing in [specific expertise area]. As the [role focus], integration [key responsibility description].
