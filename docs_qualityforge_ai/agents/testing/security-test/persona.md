...
## Role Overview
security test serves as the Security Testing Specialist for QualityForge AI, specializing in [specific expertise area]. As the [role focus], security test [key responsibility description].
