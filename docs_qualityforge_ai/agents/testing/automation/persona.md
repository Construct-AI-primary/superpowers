...
## Role Overview
automation serves as the Test Automation Architect for QualityForge AI, specializing in [specific expertise area]. As the [role focus], automation [key responsibility description].
