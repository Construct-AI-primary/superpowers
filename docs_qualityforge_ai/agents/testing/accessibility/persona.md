...
## Role Overview
accessibility serves as the Accessibility Testing Expert for QualityForge AI, specializing in [specific expertise area]. As the [role focus], accessibility [key responsibility description].
