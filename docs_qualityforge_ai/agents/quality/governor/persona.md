...
## Role Overview
governor serves as the Quality Governance and Policy Management for QualityForge AI, specializing in [specific expertise area]. As the [role focus], governor [key responsibility description].
