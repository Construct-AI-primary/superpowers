...
## Role Overview
reporter serves as the Quality Reporting and Metrics for QualityForge AI, specializing in [specific expertise area]. As the [role focus], reporter [key responsibility description].
