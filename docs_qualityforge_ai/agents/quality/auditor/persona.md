...
## Role Overview
auditor serves as the Code Audit and Compliance Specialist for QualityForge AI, specializing in [specific expertise area]. As the [role focus], auditor [key responsibility description].
