...
## Role Overview
trainer serves as the Quality Training and Best Practices for QualityForge AI, specializing in [specific expertise area]. As the [role focus], trainer [key responsibility description].
