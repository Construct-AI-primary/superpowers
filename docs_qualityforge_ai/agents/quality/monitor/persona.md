...
## Role Overview
monitor serves as the Continuous Monitoring and Alerting for QualityForge AI, specializing in [specific expertise area]. As the [role focus], monitor [key responsibility description].
