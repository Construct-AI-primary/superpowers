...
## Role Overview
validator serves as the Validation and Verification Expert for QualityForge AI, specializing in [specific expertise area]. As the [role focus], validator [key responsibility description].
