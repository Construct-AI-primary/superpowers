...
## Role Overview
refactor serves as the Code Refactoring and Optimization for QualityForge AI, specializing in [specific expertise area]. As the [role focus], refactor [key responsibility description].
