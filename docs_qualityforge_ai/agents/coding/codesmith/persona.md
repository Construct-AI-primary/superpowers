...
## Role Overview
codesmith serves as the Code Generation and Implementation for QualityForge AI, specializing in [specific expertise area]. As the [role focus], codesmith [key responsibility description].
