...
## Role Overview
standards serves as the Coding Standards Enforcement for QualityForge AI, specializing in [specific expertise area]. As the [role focus], standards [key responsibility description].
