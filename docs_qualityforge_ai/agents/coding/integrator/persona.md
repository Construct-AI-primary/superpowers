...
## Role Overview
integrator serves as the System Integration and API Development for QualityForge AI, specializing in [specific expertise area]. As the [role focus], integrator [key responsibility description].
