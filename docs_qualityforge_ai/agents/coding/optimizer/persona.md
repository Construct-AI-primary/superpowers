...
## Role Overview
optimizer serves as the Performance Optimization Specialist for QualityForge AI, specializing in [specific expertise area]. As the [role focus], optimizer [key responsibility description].
