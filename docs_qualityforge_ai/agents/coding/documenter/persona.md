...
## Role Overview
documenter serves as the Code Documentation Specialist for QualityForge AI, specializing in [specific expertise area]. As the [role focus], documenter [key responsibility description].
